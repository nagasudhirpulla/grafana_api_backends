...
using PmuHistorianUtils;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace GrafanaPmuApi.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class PmuController : ControllerBase
    {
        private readonly PmuHistFetcher _pmuHistFetcher;
        public PmuController(PmuHistFetcher pmuHistFetcher)
        {
            _pmuHistFetcher = pmuHistFetcher;
        }
        ...
        public IActionResult Query([FromBody] QueryRequest query)
        {
            ...
            foreach (QueryTarget trgt in query.Targets)
            {
                ...
                // fetch data
                var measData = _pmuHistFetcher.FetchHistData(dataObj.Pnt, query.Range.From, query.Range.To, samplingType, dataObj.SamplingPeriod, fetchShift, dataObj.FetchFuture);
